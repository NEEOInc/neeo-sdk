...
const uniqueName = require('../../../../lib/device/uniqueName.js');

describe('./lib/device/uniqueName.js', function() {
  ...
  it('should not crate the same name from a different input', function() {
