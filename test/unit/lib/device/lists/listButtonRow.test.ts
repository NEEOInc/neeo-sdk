...
import { ListButtonRow } from '../../../../../src/lib/device/lists/listButtonRow';

describe('./lib/device/lists/listButtonRow.ts', () => {
  it('should correctly build row with one button - as object', () => {
    // GIVEN
  ...
  it('should build buttons from array - one', () => {
    // GIVEN
    const buttonDefinition = [
      {
        title: 'foo',
  ...
  it('should build buttons from array - two', () => {
    // GIVEN
    const buttonDefinition = [
      {
        title: 'foo',
  ...
  it('should build buttons from array - three', () => {
    // GIVEN
    const buttonDefinition = [
      {
        title: 'foo',
  ...
  it('should not build buttons for missing definition', () => {
    // @ts-ignore
    expect(() => new ListButtonRow()).to.throw(/ERROR_LIST_BUTTONS_NO_ARRAY/);
  });
});
