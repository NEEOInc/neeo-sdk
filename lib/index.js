...
/**
 * Define settings schema and load user specified settings
 * @function
 * @param {String} unique key to identify the settings
 * @param {Object} configuration JSON Configuration Object
 * @param {NEEOBrain} configuration.schemaLocation location of the settings schema to validate user settings against
 * @param {String} configuration.settingsFileLocation location of the settings.json file that will be loaded for this settings key
 * @example
 * neeoapi.initSettings('my-driver-settings', {
 *  schemaLocation: path.resolve(__dirname),
 *  settingsFileLocation: path.resolve(__dirname)
 * });
 */
module.exports.initSettings = settings.init;

/**
 * Get user defined settings
 * @function
 * @param {String} key of the settings to get
 * @return {Object} the settings object
 * @example
 * const settings = neeoapi.getSettings('my-driver-settings');
 */
module.exports.getSettings = settings.get;
