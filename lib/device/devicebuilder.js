...
const deviceBuilder = class DeviceBuilder {
  ...
  /**
   * @function setType
   * @param {string} type supported device classes, either 'ACCESSOIRE' or 'LIGHT'
   * @description Optional parameter to define the device type. Default type is ACCESSOIRE. It is used to determine the display style and wiring suggestions in the NEEO app.
   * @return {DeviceBuilder} DeviceBuilder for chaining.
   ...
   * @description Register a discovery function for your device.
   * @return {DeviceBuilder} DeviceBuilder for chaining.
   * @example
   * .enableDiscovery(
   *   {
  ...
  enableDiscovery(messages, controller) {
    ...
    if (typeof controller !== 'function' || !messages || !messages.headerText || !messages.description) {
   ...
   * For example a device with a physical slider can use this to keep the digital slider in sync.
   * @return {DeviceBuilder} DeviceBuilder for chaining.
   * @example
   ...
   * @description Add a button for this device, can be called multiple times for multiple buttons. Needs to be used with the addButtonHandler!
   * @return {DeviceBuilder} DeviceBuilder for chaining.
   * @example
   ...
   * @description Handles the events for all the registered buttons
   * @return {DeviceBuilder} DeviceBuilder for chaining.
   * @example
