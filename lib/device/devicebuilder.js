...
const deviceBuilder = class DeviceBuilder {
   ...
   * @param {object} param An object which contains **name** (identifier of this element), **label** (optional, visible label in the mobile app or on the NEEO Remote), **type** (optional, can be range, binary, default range) **range** (optional, custom range of sensor, default 0..100), **unit** (optional user readable label, default %)
